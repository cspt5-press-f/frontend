        ...
        game: {
          ...
          soundController.listen();*/
                    ...
                    if (!token) {
                        ...
                        let lamp_image = this.add.image(this.cameras.main.centerX, this.cameras.main.centerY, 'lamp');
                        ...
                        let buttonImage = this.add
                            .image(this.cameras.main.centerX, this.cameras.main.centerY + 75, 'wood')
                            .setOrigin(0.5)
                            .setScale(0.35, 0.2)
                            .setAlpha(0.7);

                        let loginButton = this.add.text(this.cameras.main.centerX, this.cameras.main.centerY + 50, 'Login', {
                            font: '40px Arial',
                            fill: '#aaaaaa'
                        });
                        ...
                        loginButton
                            ...
                            .on('pointerover', () => loginButton.setStyle({ fill: '#ffffff', font: '40px Arial' }))
                            .on('pointerout', () => loginButton.setStyle({ fill: '#aaaaaa', font: '40px Arial' }));

                        let registerButton = this.add.text(this.cameras.main.centerX, this.cameras.main.centerY + 100, 'Register', {
                            font: '40px Arial',
                            fill: '#aaaaaa'
                        });
                        ...
                        registerButton
                            ...
                            .on('pointerover', () => registerButton.setStyle({ fill: '#ffffff', font: '40px Arial' }))
                            .on('pointerout', () => registerButton.setStyle({ fill: '#aaaaaa', font: '40px Arial' }));
                    }
                },
                update: function() {
